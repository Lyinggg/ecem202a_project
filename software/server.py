...
def doFeed():
    ...
    failMsg = ""
    global cmdNum
    print(bowlAmount, weightPerQuarter, targetAmount)
    if bowlAmount + weightPerQuarter <= targetAmount:
...
def setFre():
  ...
  FreLog = "Auto-Feed period has been set to : " + str(frequency) + "h\n";
  logging.info(FreLog)
  setLogBuf(FreLog)
  print(FreLog)
...
def setAmount():
  ...
  amountLog = "Auto-Feed amount has been set to : " + str(targetAmount) + "g\n";
  logging.info(amountLog)
  setLogBuf(amountLog)
  print(amountLog)
