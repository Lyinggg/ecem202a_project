...
bottle_3_channel = cv2.imread("/Users/hanliying/Documents/UCLA/21FALL/M202A/Project/WaterDetect/Water_Bottle.png")
...
if aspectRatio < 0.4:
    ...
    cv2.putText(bottle_clone, "Full: "+ str(1/aspectRatio*100)+ "%", (x + 10, y + 20), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
else:
    cv2.rectangle(bottle_clone, (x, y), (x + w, y + h), (0, 0, 255), 2)
    cv2.putText(bottle_clone, "Low: "+ str(1/aspectRatio*100)+ "%", (x + 10, y + 20), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 255), 2)
